...
Goal.create(name: "Stick to Budget", description: "I want to stay on budget", user_id: 1, habit_id: 4)
Goal.create(name: "Workout 3 Times a week", description: "I want to stay on budget", user_id: 2, habit_id: 4)
Goal.create(name: "Do Yoga", description: "I want to stay on budget", user_id: 3, habit_id: 4)
Goal.create(name: "Read 30 mins", description: "I want to stay on budget", user_id: 4, habit_id: 4)
Goal.create(name: "Code for 2 hours", description: "I want to stay on budget", user_id: 5, habit_id: 4)
