...
Goal.create(name: "Test", description: "I want to stay on budget", user_id: 1, habit_id: 4)
Goal.create(name: "Test", description: "I want to stay on budget", user_id: 2, habit_id: 4)
Goal.create(name: "Test", description: "I want to stay on budget", user_id: 3, habit_id: 4)
Goal.create(name: "Test", description: "I want to stay on budget", user_id: 4, habit_id: 4)
Goal.create(name: "Test", description: "I want to stay on budget", user_id: 5, habit_id: 4)
